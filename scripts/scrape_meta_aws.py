...
def main():
    ...
    print('        .report-header { background: white; padding: 1.5rem; margin-bottom: 1rem; border-radius: 8px; }')
    ...
    print('            <p><strong>Legend:</strong> 🟢 Latest version | 🟡 Mid-range version | 🔴 Oldest version</p>')
    print('        </div>')
    print('        <table>')
    print('            <thead>')
    print('                <tr>')
