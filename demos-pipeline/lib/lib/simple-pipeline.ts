 ...
 */
export class SimplePipelineStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: SimplePipelineProps) {
    super(scope, id, props);
    /** Set up a default value for the demo BUILD_DEVICE. */
    const device = props.device ?? SimpleDeviceKind.Qemu;
