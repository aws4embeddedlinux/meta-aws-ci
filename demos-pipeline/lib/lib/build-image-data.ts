...
export class BuildImageDataStack extends cdk.Stack {
    ...
    private createDeploymentBucket(bucketName: string): s3.IBucket {
        ...
        const dataBucket = new s3.Bucket(this, 'BuildImageDataBucket', { bucketName, versioned: true });

        const dataBucketDeploymentRole = new iam.Role(this, 'BuildImageBucketRole', {
