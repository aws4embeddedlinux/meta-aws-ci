...
export class BuildImagePipelineStack extends cdk.Stack {
    constructor(scope: Construct, id: string, props: BuildImagePipelineProps) {
        ...
        const buildImageProject = new codebuild.PipelineProject(this, 'BuildImageProject', {
            buildSpec: codebuild.BuildSpec.fromSourceFilename(`${props.imageKind}/buildspec.yml`),
            environment: {
        ...
        new events.Rule(this, 'WeeklySchedule', {
            schedule: events.Schedule.cron({ weekDay: 'Monday', minute: '0', hour: '6' }),
